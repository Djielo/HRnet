                  ...
                  (i = l[0].clientHeight),
                    ...
                    1 < n
                      ...
                      : (u.show(),
                        ...
                        !0 !== a &&
                          l.trigger("scroll_element.xdsoft_scroller", [t || Math.abs(parseInt(o.css("marginTop"), 10)) / (s - i)]));
                }),
              l.on("mousewheel", function (e) {
                var t = Math.abs(parseInt(o.css("marginTop"), 10));
                return (
                  (t -= 20 * e.deltaY) < 0 && (t = 0), l.trigger("scroll_element.xdsoft_scroller", [t / (s - i)]), e.stopPropagation(), !1
                );
              }),
          ...
          F.find(".xdsoft_select")
            ...
            (_.setOptions = function (e) {
              ...
              (N = L.extend(!0, {}, N, e)),
                ...
                N.minDateTime &&
                  /^\+(.*)$/.test(N.minDateTime) &&
                  (N.minDateTime = W.strToDateTime(N.minDateTime).dateFormat(N.formatDate)),
                N.maxDateTime &&
                  /^\+(.*)$/.test(N.maxDateTime) &&
                  (N.maxDateTime = W.strToDateTime(N.maxDateTime).dateFormat(N.formatDate)),
                  ...
                  O.off("blur.xdsoft").on("blur.xdsoft", function () {
                    if (
                      ...
                      (!L.trim(L(this).val()).length ||
                        ("string" == typeof N.mask && L.trim(L(this).val()) === N.mask.replace(/[0-9]/g, "_")))
                    )
            ...
            (W = new (function () {
              ...
              (r.now = function (e) {
                ...
                (r.str = function () {
                  ...
                  return (
                    N.yearOffset &&
                      (e = (e = e.replace("Y", r.currentTime.getFullYear() + N.yearOffset)).replace(
                        "y",
                        String(r.currentTime.getFullYear() + N.yearOffset).substring(2, 4)
                      )),
            ...
            _.on("xchange.xdsoft", function (e) {
                ...
                (t = setTimeout(function () {
                  ...
                  for (
                    l += "</tr></thead>",
                      l += "<tbody>",
                      !1 !== N.maxDate &&
                        ((h = W.strToDate(N.maxDate)), (h = new Date(h.getFullYear(), h.getMonth(), h.getDate(), 23, 59, 59, 999))),
                    ...
                    (y = []),
                      ...
                      N.allowDateRe &&
                        "[object RegExp]" === Object.prototype.toString.call(N.allowDateRe) &&
                        (N.allowDateRe.test(E.formatDate(f, N.formatDate)) || y.push("xdsoft_disabled")),
                      N.allowDates &&
                        0 < N.allowDates.length &&
                        -1 === N.allowDates.indexOf(E.formatDate(f, N.formatDate)) &&
                    ...
                    ((!1 !== h && h < f) || (!1 !== p && f < p) || (!1 !== g && f < g) || (!1 !== D && u < k) || (i && !1 === i[0])) &&
                      ...
                      (N.defaultSelect || _.data("changed")) &&
                        E.formatDate(W.currentTime, N.formatDate) === E.formatDate(f, N.formatDate) &&
                        y.push("xdsoft_current"),
                      E.formatDate(m, N.formatDate) === E.formatDate(f, N.formatDate) && y.push("xdsoft_today"),
                      (0 !== f.getDay() && 6 !== f.getDay() && -1 === N.weekends.indexOf(E.formatDate(f, N.formatDate))) ||
                        y.push("xdsoft_weekend"),
                      void 0 !== N.highlightedDates[E.formatDate(f, N.formatDate)] &&
                        ((t = N.highlightedDates[E.formatDate(f, N.formatDate)]),
              ...
              N.timepicker &&
                ...
                e
                  ? ((t = u[0].clientHeight),
                    (a = P[0].offsetHeight) - t < (n = P.find(e).index() * N.timeHeightInTimePicker + 1) && (n = a - t),
            ...
            C.on("touchend click.xdsoft", "td", function (e) {
              ...
              a.setDate(1),
                ...
                (1 < n || !0 === N.closeOnDateSelect || (!1 === N.closeOnDateSelect && !N.timepicker)) &&
                  !N.inline &&
              ...
              "rtl" === s.parent().css("direction") && (n -= _.outerWidth() - s.outerWidth()),
                N.fixed
                  ...
                  : ((i = !1),
                    h(t, function (e) {
                      return (
                        null !== e && ("fixed" === N.contentWindow.getComputedStyle(e).getPropertyValue("position") ? !(i = !0) : void 0)
                      );
                    }),
                    i && !N.insideParent
                ...
                (o = _[0]),
                h(o, function (e) {
                  if ("relative" === N.contentWindow.getComputedStyle(e).getPropertyValue("position") && d >= e.offsetWidth)
